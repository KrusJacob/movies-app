...
const MovieMediaPlayer = ({ id }: { id: string }) => {
  ...
  return (
    <div>
      {isLoading ? (
        ...
        <div className="text-xl flex justify-center items-center h-[200px] border border-black">{error}</div>
      ) : (
...
export default MovieMediaPlayer;
